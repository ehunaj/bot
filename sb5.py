...
#kk = LineClient(id='nrsfamil1@gmail.com',passwd='ehun4321')
        ...
        if op.type == 13:
            if op.param3 in bl['blacklist'] and op.param2 in bl['blacklist'] and op.param2 not in Bots and op.param2 not in admin and op.param2 not in Creator:
                ...
                try:
                    ...
                    pass
            if op.param3 in bl['blacklist'] and op.param2 in bl['blacklist'] and op.param2 not in Bots and op.param2 not in admin and op.param2 not in Creator:
                s2.cancelGroupInvitation(op.param1,[op.param3])
                s2.kickoutFromGroup(op.param1,[op.param2])
                try:
                    Inviter = op.param3.replace("",',')
                    InviterX = Inviter.split(",")
                    for tag in InviterX:
                        if tag in bl["blacklist"]:
                            try:
                                s2.cancelGroupInvitation(op.param1,[tag])
                                s2.kickoutFromGroup(op.param1,[op.param2])
                            except:
                                pass
                except:
                    pass
            if op.param3 in bl['blacklist'] and op.param2 in bl['blacklist'] and op.param2 not in Bots and op.param2 not in admin and op.param2 not in Creator:
                s1.cancelGroupInvitation(op.param1,[op.param3])
                s1.kickoutFromGroup(op.param1,[op.param2])
                try:
                    Inviter = op.param3.replace("",',')
                    InviterX = Inviter.split(",")
                    for tag in InviterX:
                        if tag in bl["blacklist"]:
                            try:
                                s1.cancelGroupInvitation(op.param1,[tag])
                                s1.kickoutFromGroup(op.param1,[op.param2])
                            except:
                                pass
                except:
            ...
            if mid in op.param3:
                ...
                if op.param2 in admin:
                    ...
                    try:
                        ...
                        s2.acceptGroupInvitation(op.param1)
                        s3.acceptGroupInvitation(op.param1)
                        s3kickoutFromGroup(op.param1,[op.param2])
                    except:
                        pass
