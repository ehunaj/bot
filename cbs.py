...
#Creator = ["ub4a5fb1373abf37ca29fa0bc39423154","ub3808de9f7df35f57fb366d157f9790a"]
#admin = ["ue16e699cd3909714362490105d0eea31","u57d4af969665f5f06a3f4271978c57cf","uc1cec43fea8699aa070a7b4a54d19c35","ub7e2141f86beeb719ae370500b851152","u4f176ed347855fad59710edf12063d10","uffc1812fd68db3c5a23ee1e6128e7456","ub4a5fb1373abf37ca29fa0bc39423154","ub3808de9f7df35f57fb366d157f9790a"]
clbot = {
...
class LineBot(object):
    def __init__(self, resp, authToken=None):
        self.resp = resp
        self.resp = self.resp+' '
 ...
 #       self.login(authQR)
    ...
    def login(self, api):
        if api == None:
            ...
            self.client = LineClient(api)
        self.client.log("Auth Token :" + str(self.client.authToken))
        Imid = self.client.profile.mid
        poll = LinePoll(self.client)
        call = LineCall(self.client)
    ...
    def bot(self, op):
        Imid = self.Imid
        ehun = self.client
        responsename = ehun.profile.displayName
...
#========================================
            ...
            if op.type == 13:
                if op.param3 in bl["blaclist"] and op.param2 in bl["blacklist"]:
